                ...
                <div className="my-5 py-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="open-hours bg-gray-50 p-6 rounded-xl flex  flex-col hover:bg-gray-100 transition-colors duration-300">
                        ...
                        <ul className="text-gray-500 space-y-2">
                            <li className="font-medium hover:text-violet-700 transition-all duration-300">الأيام : من السبت الي الخميس</li>
                            <li className="font-medium hover:text-violet-700 transition-all duration-300">المواعيد : من الساعة التاسعة صباحًا إلى السابعة والنصف مساءً</li>
                        </ul>
                   ...
                   <ul className="text-gray-500 space-y-2">
                            <li className="font-medium flex gap-2 hover:text-violet-700 transition-all duration-300">
